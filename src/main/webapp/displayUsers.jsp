	...
	<table>
		...
		<c:forEach var="Feedbacks" items="${Feedbacks}">
			<tr>
				...
				<td>${Feedbacks.gmail}</td>
				<td>${Feedbacks.password}</td>
				<td>${Feedbacks.phone}</td>
				
				
     <td>
        <a href= "UpdateProfile.jsp?id=${Feedbacks.id}&name=${Feedbacks.name}&email=${Feedbacks.gmail}&password=${Feedbacks.password}&phone=${Feedbacks.phone}">
